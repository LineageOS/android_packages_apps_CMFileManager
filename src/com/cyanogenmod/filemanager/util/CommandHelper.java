...
public final class CommandHelper {
    ...
    private static class UnmountAsyncResultListener implements AsyncResultListener {
        ...
        public void onAsyncExitCode(int exitCode) {
            ...
            try {
                final Console mountConsole = ConsoleBuilder.getMountConsole(this.mCtx);
                if (this.mUnmount && mountConsole != null &&
                                        ...
                                        mountConsole.
                                            getExecutableFactory().newCreator().
                                                createMountExecutable(
                                                        ...
                                                        false);
                                mountConsole.execute(unmountExecutable);
                            } catch (Exception e) {
                ...
                // Ignore
            } catch (InvalidCommandDefinitionException e1) {
                // Ignore
            } catch (ConsoleAllocException e1) {
                // Ignore
            }
        }
