 ...
 */
public class CirclePageIndicator extends View implements
        PageIndicator {
    private static final int INVALID_POINTER = -1;

    private float mRadius;
    private final android.graphics.Paint mPaintPageFill = new android.graphics.Paint(ANTI_ALIAS_FLAG);
    private final android.graphics.Paint mPaintStroke = new android.graphics.Paint(ANTI_ALIAS_FLAG);
    private final android.graphics.Paint mPaintFill = new android.graphics.Paint(ANTI_ALIAS_FLAG);
    ...
    public CirclePageIndicator(android.content.Context context) {
        this(context, null);
    }

    public CirclePageIndicator(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, R.attr.vpiCirclePageIndicatorStyle);
    }

    public CirclePageIndicator(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        ...
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CirclePageIndicator, defStyle, 0);
        ...
        android.graphics.drawable.Drawable background = a.getDrawable(R.styleable.CirclePageIndicator_android_background);
        if (background != null) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent ev) {
        ...
        switch (action) {
            ...
            case android.view.MotionEvent.ACTION_MOVE: {
                final int activePointerIndex = android.support.v4.view.MotionEventCompat.findPointerIndex(ev, mActivePointerId);
                final float x = android.support.v4.view.MotionEventCompat.getX(ev, activePointerIndex);
            ...
            case android.support.v4.view.MotionEventCompat.ACTION_POINTER_DOWN: {
                ...
                mLastMotionX = android.support.v4.view.MotionEventCompat.getX(ev, index);
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == android.view.View.MeasureSpec.EXACTLY) || (mViewPager == null)) {
    ...
    public void onRestoreInstanceState(android.os.Parcelable state) {
        com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState savedState = (com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState)state;
    ...
    public android.os.Parcelable onSaveInstanceState() {
        ...
        com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState savedState = new com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState(superState);
    ...
    static class SavedState extends android.view.View.BaseSavedState {
        ...
        public static final android.os.Parcelable.Creator<com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState> CREATOR = new android.os.Parcelable.Creator<com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState>() {
            @Override
            public com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState createFromParcel(
                    android.os.Parcel in) {
                return new com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState(in);
            }

            @Override
            public com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState[] newArray(int size) {
                return new com.cyanogenmod.filemanager.views.CirclePageIndicator.SavedState[size];
            }
        };
    }
}
