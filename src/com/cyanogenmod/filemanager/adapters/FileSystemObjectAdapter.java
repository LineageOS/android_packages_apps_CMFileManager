...
public class FileSystemObjectAdapter
    ...
    private void setFolderIcon(ImageView view, int iconId) {
        ...
        setIcon(view, mRes.getDrawable(iconId), R.color.default_primary, R.drawable.ic_icon_background,
                transparentColor);
    }
    ...
    /*private Runnable mLoadThumbnail = new Runnable(ImageView view, Drawable icon, boolean isThumbnail) {
        @Override
