    ...
    public void initialize() {
        ...
        if (this.mResourcesResolver != null) {
            this.mKeyColor = this.mResourcesResolver.getColor(
                    HighlightColors.NORMAL.getResId(), HighlightColors.NORMAL.getDefault());
            this.mAssignmentColor = this.mResourcesResolver.getColor(
                    HighlightColors.ASSIGMENT.getResId(), HighlightColors.ASSIGMENT.getDefault());
            ...
            this.mValueColor = this.mResourcesResolver.getColor(
                    HighlightColors.VARIABLE.getResId(), HighlightColors.VARIABLE.getDefault());
            this.mArgumentColor = this.mResourcesResolver.getColor(
                    HighlightColors.KEYWORD.getResId(), HighlightColors.KEYWORD.getDefault());
        } else {
            // By default
            this.mKeyColor = HighlightColors.NORMAL.getDefault();
            this.mAssignmentColor = HighlightColors.NORMAL.getDefault();
