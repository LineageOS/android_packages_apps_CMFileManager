...
public class IconHolder {
    ...
    private Handler mHandler = new Handler() {
        ...
        private void processResult(LoadResult result) {
		    ...
		    android.util.Log.d("foo", "set drawable: old " + old.getIntrinsicWidth() + "x" + old.getIntrinsicHeight()
			    + ", new " + result.result.getIntrinsicWidth() + "x" + result.result.getIntrinsicHeight());
