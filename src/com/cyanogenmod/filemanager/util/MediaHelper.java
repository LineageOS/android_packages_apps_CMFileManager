...
public final class MediaHelper {
     ...
     */
    public static Uri fileToContentUri(Context context, File file, String mimeType) {
        ...
        Uri uri = fileToContentUri(context, normalizedPath, EXTERNAL_VOLUME, mimeType);
        if (uri != null) {
            return uri;
        }
        uri = fileToContentUri(context, normalizedPath, INTERNAL_VOLUME, mimeType);
        if (uri != null) {
            return uri;
        }
        return null;
     ...
     * @return Uri The content uri or null if file not exists in the media database
     */
    private static Uri fileToContentUri(Context context, String path, String volume, String mimeType) {
