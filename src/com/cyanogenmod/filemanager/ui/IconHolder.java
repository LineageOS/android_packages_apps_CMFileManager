...
public class IconHolder {
    ...
    private Map<String, Integer> mAlbums;      // Media albums
    ...
    public IconHolder(boolean useThumbs) {
        ...
        this.mAlbums = new HashMap<String, Integer>();
    }
     ...
     * @return Drawable The drawable or null if cannot be extracted
     */
    private static Drawable getAlbumDrawable(Context context, int albumId) {
