...
public class PropertiesSyntaxHighlightProcessor extends SyntaxHighlightProcessor {
    ...
    private final int mAssignmentColor;
    private final int mCommentColor;
    private final int mValueColor;
    private final int mArgumentColor;

    /**
     * Constructor of <code>PropertiesSyntaxHighlightProcessor</code>
     */
    public PropertiesSyntaxHighlightProcessor() {
        super();
        this.mKeyColor = Color.argb(153, 0, 0, 0);
        this.mAssignmentColor = Color.argb(153, 0, 0, 0);
        this.mCommentColor = Color.argb(153, 0, 128, 0);
        this.mValueColor = Color.argb(255, 127, 159, 191);
        this.mArgumentColor = Color.argb(153, 127, 0, 85);
    }
