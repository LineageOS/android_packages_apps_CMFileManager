...
public class SearchActivity extends Activity
    ...
    void doSearch(
        ...
        if (mMimeTypeCategories == null) {
            ...
            for (MimeTypeCategory category : mMimeTypeCategories) {
                localizedNames
                        .add(MimeTypeHelper.MimeTypeCategory.getFriendlyLocalizedNames(this)[category.ordinal()]);
            }
             this.mSearchTerms.setText(
    ...
    boolean navigateTo(FileSystemObject fso) {
        if (fso != null) {
            ...
            IntentsActionPolicy.openFileSystemObject(this, mSearchListView, fso, false, null, null);
        } else {
            // The fso not exists, delete the fso from the search
            try {
                removeItem(fso);
