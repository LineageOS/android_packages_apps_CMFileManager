...
import com.cyanogenmod.filemanager.activities.preferences.PreferenceHelper;
...
public class SortViewOptions {
    ...
    private CheckBox mHiddenCheckbox;
    ...
    private void setSettingType(FileManagerSettings settingType) {
        if (settingType == FileManagerSettings.SETTINGS_SORT_MODE) {
            ...
            mHiddenCheckbox.setVisibility(View.GONE);
        }  else {
            throw new IllegalArgumentException("Unsupported setting type");
        }

        // if in safe mode, don't show the option to show hidden files
    ...
    private void init(View parent) {
        ...
        mHiddenCheckbox = (CheckBox)parent.findViewById(R.id.show_hidden);

        boolean showHidden =
                PreferenceHelper.getBooleanPreference(FileManagerSettings.SETTINGS_SHOW_HIDDEN);
        mHiddenCheckbox.setChecked(showHidden);
    }
    ...
    /**
     * @return true if the user wants to show hidden files
     */
    public boolean getShowHiddenFiles() {
        return mHiddenCheckbox.isChecked();
    }
                ...
                layout, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        listener.onClick(dialog, which, sortViewOptions.getSortId(),
                                sortViewOptions.getShowHiddenFiles());
                    }
                });
    }
}
