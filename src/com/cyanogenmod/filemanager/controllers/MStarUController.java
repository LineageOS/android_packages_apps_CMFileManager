...
public class MStarUController {
    ...
    private View.OnClickListener mOnItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            MStarUController.ViewHolder h = (MStarUController.ViewHolder)view.getTag(R.id.tag_viewholder);
    ...
    public void replaceData(List<FileSystemObject> files) {
        ...
        for (; i < size; i++) {
            ...
            MStarUController.ViewHolder h = (MStarUController.ViewHolder)row.getTag(R.id.tag_viewholder);
