...
public final class CommandHelper {
   ...
   public static boolean createLink(Context context, String src, String link, Console console)
    ...
    public static boolean move(Context context, String src, String dst, String name,
        ...
        if (cSrc.equals(cDst) && (!FileHelper.isSamePath(src, dst) ||
            ...
            try {
                ...
                // User isn't alerted about a command failure unless an exception is thrown.
                if (!ret) {
                    // Alert failed move operation
    ...
    public static WriteExecutable write(
        ...
        throw new ExecutionException(String.format("Fail to create file %s in %s", name, parent)); //$NON-NLS-1$
    }
