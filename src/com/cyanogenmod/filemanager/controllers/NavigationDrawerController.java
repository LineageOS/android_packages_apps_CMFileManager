...
public class NavigationDrawerController implements ResultCallback<ProviderInfoListResult>,
    ...
    private void loadStorageProviderItems(List<StorageProviderInfo> storageProviderInfos,
        ...
        for (StorageProviderInfo providerInfo : storageProviderInfos) {
            ...
            if (StorageProviderUtils.isStorageProviderAdded(mCtx, String.valueOf(providerHashCode))
                    &&
    ...
    private void updateItemSelectionAndInvalidate(NavigationDrawerItem item) {
    ...
    private class AddProviderInfoTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            mIcon = StorageProviderUtils.loadPackageIcon(mCtx,
