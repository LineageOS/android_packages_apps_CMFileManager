...
public class FileSystemInfoTask extends AsyncTask<String, Integer, Void> {
     ...
     */
    public FileSystemInfoTask(Context context, NavigationFragment navigationFragment,
            int freeDiskSpaceWarningLevel) {
        this(context, navigationFragment, freeDiskSpaceWarningLevel, false);
    }
    ...
    protected Void doInBackground(String... params) {
        ...
        if (mountPoint == null) {
            ...
            try {
                ...
                diskUsage = new DiskUsage(mountPoint.getMountPoint(), 0, 0, 0);
            }
            int usage = 0;
