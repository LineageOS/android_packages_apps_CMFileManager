...
public class IconHolder {
    ...
    private Handler mHandler = new Handler() {
        ...
        private void processResult(LoadResult result) {
            ...
            mAppIcons.put(result.fso.getFullPath(), result.result);
     ...
     */
    public void loadDrawable(ImageView iconView, FileSystemObject fso) {
        if (!mUseThumbs) {
            return;
        }
    ...
    private class WorkerHandler extends Handler {
        ...
        private Drawable loadDrawable(FileSystemObject fso) {
            ...
            if (KnownMimeTypeResolver.isAndroidApp(mContext, fso)) {
                ...
                return getImageDrawable(MediaHelper.normalizeMediaPath(filePath));
            } else if (KnownMimeTypeResolver.isVideo(mContext, fso)) {
                return getVideoDrawable(MediaHelper.normalizeMediaPath(filePath));
