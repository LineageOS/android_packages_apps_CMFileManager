...
public final class MimeTypeHelper {
    ...
    private static final MimeTypeInfo getMimeTypeInternal(FileSystemObject fso, String ext, boolean firstFound) {
    ...
    private static final MimeTypeInfo getMimeTypeInternal(String absolutePath, String ext, boolean firstFound) {
