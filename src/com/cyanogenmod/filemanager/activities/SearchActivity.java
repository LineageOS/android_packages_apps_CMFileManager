...
public class SearchActivity extends Activity
    ...
    private void initSearch() {
        ...
        if (mimeTypeExtra instanceof MimeTypeCategory[]) {
        ...
        } else {    // a single category was passed in
            // setting load factor to 1 to avoid map resizing
            mMimeTypeCategories = new HashSet<MimeTypeCategory>(1, 1);
            mMimeTypeCategories.add((MimeTypeCategory) mimeTypeExtra);
        }
